...
while True :
    ...
    if gender_input.lower() == "f": heshe = "She"; hisher = "Her"; guygirl = "girl"; himher = "her"; girlguy = "guy";break
    elif gender_input.lower() == "m": heshe = "He"; hisher = "His"; guygirl = "guy"; himher = "him"; girlguy = "girl";break
...
watermark_font = ImageFont.truetype('Ginga.ttf',size=24)
...
ImageDraw.Draw(image).text((1000-400,1000-30),'Python Script Made By RISHABH GUPTA',fill='rgb(0,0,0)',font=watermark_font)
